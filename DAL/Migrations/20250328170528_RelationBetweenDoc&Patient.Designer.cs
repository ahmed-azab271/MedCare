...
namespace DAL.Migrations
{
    ...
    [Migration("20250328170528_RelationBetweenDoc&Patient")]
    partial class RelationBetweenDocPatient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.AccountUser", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.Patient", b =>
                {
                    b.HasOne("DAL.Models.AccountUser", "AccountUser")
                        .WithMany()
                        .HasForeignKey("AccountUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Models.Doctor", "DoctorModel")
                        .WithMany("Patients")
                        .HasForeignKey("DoctorId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DAL.Models.AccountUser", null)
                        .WithMany()
